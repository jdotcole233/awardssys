...
get_response_ward_type(silver_points_build, no) :- write(' ').
...
get_response_ward_type(gold_points_build, no) :- write(' ').

get_response_ward_type(bronze_points_build, no) :- write(' ').
...
get_response_first(different_types_of_awards, yes) :- nl, nl,
                                                ...
                                                get_yes_or_no(Respons), nl,
                                                get_response_ward_type(silver_points_build, Respons), nl,

                                                write('Do you want to know about GOLD AWARD?'), nl,
                                                get_yes_or_no(Respon), nl,
                                                get_response_ward_type(gold_points_build, Respon), nl,

                                                write('Do you want to know about BRONZE AWARD?'), nl,
                                                get_yes_or_no(Response), nl,
                                                get_response_ward_type(bronze_points_build, Response), nl.
...
get_response_first(build_points, no) :- write('').
...
advice_second(work_experience, no) :- write('').
...
second_year_responses(registered_lancaster_award, no) :-
                                        ...
                                        write('For fairness and parity with other students we cannot tell you what to write but can provide you with feedback').
